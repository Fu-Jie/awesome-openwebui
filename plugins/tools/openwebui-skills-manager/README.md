...
| By [Fu-Jie](https://github.com/Fu-Jie) · v0.3.4 | [⭐ Star this repo](https://github.com/Fu-Jie/openwebui-extensions) |
| :--- | ---: |
...
- **🔄 OpenWebUI 0.11.1+ Compatibility**: Uses the new user-scoped `Skills.get_skills(user_id=...)` API while retaining compatibility with older `get_skills_by_user_id(...)` versions.
- **🧪 Skills API Regression Coverage**: Added tests for legacy and current SkillsTable APIs and protection against unscoped skill queries.
